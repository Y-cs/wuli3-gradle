...
internal object ConventionProperties {
    ...
    const val JACOCO_LINE_MINIMUM = "wuli3.conventions.jacoco.line.minimum"
    const val JACOCO_VERIFICATION_ENABLED = "wuli3.conventions.jacoco.verification.enabled"
    ...
    const val PALANTIR_JAVA_FORMAT_VERSION = "wuli3.conventions.palantir-java-format.version"
    const val PROJECT_BOM_PATH = "wuli3.conventions.project-bom-path"
    const val SPOTLESS_ENABLED = "wuli3.conventions.spotless.enabled"
