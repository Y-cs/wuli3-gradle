...
public record ErrorPropagationProtocol(
    ...
    public Class<? extends ErrorCode> getErrorType() {
        return ErrorPropagationProtocol.class;
    }

    /** 判断错误码是否为跨服务接收的错误。 */
    public static boolean isRemoteError(final ErrorCode errorCode) {
        return errorCode instanceof ErrorPropagationProtocol;
    }
}
