...
import com.kjs.wuli3.core.error.propagation.DefaultErrorCodeCarrierCodec;
...
class DefaultErrorCodeCarrierCodecTest {
    ...
    private final ErrorCodeCarrierCodec codec = new ErrorCodeCarrierCodec(new DefaultErrorCodeResolver("group"), "group");
