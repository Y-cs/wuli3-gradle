...
public class RocketMqAutoConfiguration {
    ...
    RocketMqEventMessageEncoder rocketMqEventMessageEncoder(final ObjectProvider<ContextReader> contextReaders,
            final RocketMqEventProperties properties) {
        return new RocketMqEventMessageEncoder(contextReaders.getIfUnique(), properties.getContextMode());
    }
    ...
    RocketMqRemoteEventMessageTransport rocketMqRemoteEventMessageTransport(final RocketMQTemplate rocketMQTemplate,
